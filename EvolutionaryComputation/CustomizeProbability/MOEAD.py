...
import Visual
import MakeTarget
objectives=("different","complexity","errors")
...
def run():
    ...
    #Initilize
    target=MakeTarget.connect(MakeTarget.clamp([Point(0,0.5),Point(1280,0.95),Point(2048,1),Point(2816,0.95),Point(4096,0.5),Point(9000,0.01)]))
    ...
    offsprings=Crossover.crossover(population,neighbours)
